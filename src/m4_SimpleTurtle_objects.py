...
###############################################################################
natasha.speed=5
natasha.go_to(rg.Point(200,100))
natasha.go_to(rg.Point(100,200))
...
#
###############################################################################
naughty_turtle=rg.SimpleTurtle('turtle')
naughty_turtle.pen=rg.Pen('yellow',10)
naughty_turtle.speed=10

for k in range(6):
    naughty_turtle.forward(100)
    naughty_turtle.left(60)
